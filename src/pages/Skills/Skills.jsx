...
import { BsFileEarmarkCode, BsGrid1X2, BsCheckCircle, BsBrush, BsScissors } from "react-icons/bs";
  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "Svelte", icon: <SiSvelte className="w-4 h-4 text-[#FF3E00]" /> },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Lua", icon: <SiLua className="w-4 h-4 text-[#2C2D72]" /> },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "TestComplete", icon: <BsCheckCircle className="w-4 h-4 text-[#00C853]" /> },
        { name: "Redux", icon: <SiRedux className="w-4 h-4 text-[#764ABC]" /> },
        { name: "Firebase", icon: <SiFirebase className="w-4 h-4 text-[#FFCA28]" /> },
        { name: "Vercel", icon: <SiVercel className="w-4 h-4 text-white" /> },
        { name: "Vite", icon: <SiVite className="w-4 h-4 text-[#646CFF]" /> },
        { name: "Visual Basic", icon: <BsFileEarmarkCode className="w-4 h-4 text-[#945DB7]" /> },
      ],
    },
    {
      icon: Paintbrush,
      ...
      skills: [
        { name: "Canvas", icon: <BsBrush className="w-4 h-4 text-[#FFB74D]" /> },
        { name: "Video Editing", icon: <MdMovie className="w-4 h-4 text-[#42A5F5]" /> },
        { name: "Sound Design", icon: <FaMusic className="w-4 h-4 text-[#AB47BC]" /> },
        { name: "Capcut", icon: <BsScissors className="w-4 h-4 text-[#E0E0E0]" /> },
      ],
    },
  ];
