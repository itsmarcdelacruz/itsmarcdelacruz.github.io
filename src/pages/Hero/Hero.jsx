...
export default function Hero() {
  ...
  const resumeUrl = "/Marc%20Delacruz%20Resume.pdf";
  const resumeDownloadName = "Marc-Delacruz-Resume.pdf";

  const [code] = useState(`
const profile = {
  name: 'Marc Delacruz',
  title: 'CS Student | University of Michigan',
  focus: ['Web', 'UI/UX', 'AI/ML'],
  skills: [
    'JavaScript', 'React', 'Node.js',
    'Python', 'SQL', 'Git', 'Sass'
  ],
  learning: ['TypeScript', 'Next.js', 'Cloud'],
  seeking: 'internships and collaborations',
  mindset: 'builds reliable, thoughtful experiences'
};
  `);
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-6 sm:mb-8">
                <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold leading-tight">
                  ...
                  <span className="relative inline-block">
                    I&apos;m
                    <span className="typing-effect gradient-text"> Marc Delacruz</span>
                  </span>
                </h1>
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Computer Science student focused on building reliable, user-first
                  web experiences. Developing full-stack skills while exploring AI/ML
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/itsmarcdelacruz"
